  ...
  return (
    <div className='w-full h-screen relative'>
        ...
        <div className='absolute top-0 h-full w-full flex flex-col text-center text-white p-4 justify-center'>
            ...
            <form className='flex justify-between relative items-center w-full border p-1 
            max-w-[700px] rounded-md text-black bg-[#f4f4f4f0] mx-auto '>
                <div>
                    <input type="text" className='bg-transparent focus:outline-none w-[300px] sm:w-[400px] font-[Poppins]'  placeholder='Destinations' />
                </div>
                <div>
